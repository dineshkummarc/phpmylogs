...
class CILogViewers {
    ...
    const LOG_VIEW_FILE_FOLDER = APPPATH . "views/getlogs"; //Changes done here
    const LOG_VIEW_FILE_NAME = "getlogs.php";
    const LOG_VIEW_FILE_PATH = self::LOG_VIEW_FILE_FOLDER . "/" . self::LOG_VIEW_FILE_NAME;
    const CI_LOG_VIEW_FILE_PATH = "getlogs";
