...
<head>
  ...
  <script src="/js/json-viewer/json-viewer.js"></script>
  <link rel="stylesheet" href="/js/json-viewer/json-viewer.css">
...
<!--
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <!--
          ...
          -->
      <li class="nav-item {{ Route::is('log-viewer::logs.list', ['fpm-fcgi']) && $type === 'fpm-fcgi' ? 'active' : '' }}">
        <a href="{{ route('log-viewer::logs.list', ['fpm-fcgi']) }}" class="nav-link">
          <i class="fa fa-server"></i> FPM
        </a>
      </li>
      <li class="nav-item {{ Route::is('log-viewer::logs.list', ['cli']) && $type === 'cli' ? 'active' : '' }}">
        <a href="{{ route('log-viewer::logs.list', ['cli']) }}" class="nav-link">
